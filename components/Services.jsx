    ...
    return (
        <div className='w-full px-[12%] py-10 scroll-mt-20' id='services'>
            ...
            <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut possimus fugit delectus distinctio, inventore eos sapiente error temporibus!
            </p>
            ...
            <div className='grid grid-cols-auto gap-6 my-14'>
                {
                    serviceData.map(({icon,title,description,link},index)=>(
                        ...
                        dark:hover:bg-darkHover dark:hover:shadow-white' key={index}>
